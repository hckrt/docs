...
```
GET https://admin.hackgate.io/api/analytics/getWAFMessages
```
...
```bash
curl "https://admin.hackgate.io/api/analytics/getWAFMessages?url=my-site&gte=2025-07-01T00:00:00Z&lte=2025-07-14T23:59:59Z" \
...
```
GET https://admin.hackgate.io/api/analytics/getWAFAttackTypes
```
...
```bash
curl "https://admin.hackgate.io/api/analytics/getWAFAttackTypes?url=my-site&gte=2025-07-01T00:00:00Z&lte=2025-07-14T23:59:59Z" \
  -H "Authorization: Bearer <token>"
```
...
```
GET https://admin.hackgate.io/api/analytics/getAPICoverage
```
...
```bash
curl "https://admin.hackgate.io/api/analytics/getAPICoverage?url=my-site&gte=2025-07-01T00:00:00Z&lte=2025-07-14T23:59:59Z" \
  -H "Authorization: Bearer <token>"
```
