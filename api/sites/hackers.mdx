...
```
GET https://admin.hackgate.io/api/sites/getHackers/{id}
```
...
```bash cURL
curl https://admin.hackgate.io/api/sites/getHackers/a1b2c3d4-e5f6-7890-abcd-ef1234567890 \
...
```
POST https://admin.hackgate.io/api/sites/addHacker
```
...
```
POST https://admin.hackgate.io/api/sites/removeHacker
```
...
```
POST https://admin.hackgate.io/api/sites/allowedHackerType
```
