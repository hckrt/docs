...
```
POST https://admin.hackgate.io/api/sites/uploadOpenAPISchema
```
...
```
GET https://admin.hackgate.io/api/sites/getAPIdefinition/{id}
```
...
```bash cURL
curl https://admin.hackgate.io/api/sites/getAPIdefinition/a1b2c3d4-e5f6-7890-abcd-ef1234567890 \
  -H "Authorization: Bearer <token>"
```
